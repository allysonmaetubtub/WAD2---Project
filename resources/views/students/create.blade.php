                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('students') }}">
                        ...
                        <div class="form-group{{ $errors->has('english') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="english" type="text" class="form-control" name="english" value="{{ old('english') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('math') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="math" type="text" class="form-control" name="math" value="{{ old('math') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('filipino') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="filipino" type="text" class="form-control" name="filipino" value="{{ old('filipino') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('science') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="science" type="text" class="form-control" name="science" value="{{ old('science') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('mapeh') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mapeh" type="text" class="form-control" name="mapeh" value="{{ old('mapeh') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('epp') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="epp" type="text" class="form-control" name="epp" value="{{ old('epp') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('cl') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cl" type="text" class="form-control" name="cl" value="{{ old('cl') }}" required autofocus>
