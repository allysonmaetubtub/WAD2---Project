        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('profile.update', ['id' => auth()->user()->id]) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="teacher_id" type="text" class="form-control" name="teacher_id" value="{{ $user->teacher_id }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('advisory_class') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="advisory_class" type="advisory_class" class="form-control" name="advisory_class" value="{{ $user->section->name }}" required>
                        ...
                        <div class="form-group{{ $errors->has('grade_level') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="grade_level" type="grade_level" class="form-control" name="grade_level" value="{{ $user->section->grade_level }}" required>
